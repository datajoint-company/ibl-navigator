...
app.post('/newdatasessions', checkAuth, cacheMiddleware(15*60), (req, res) => {
    ...
    let values = [{
        "subject_uuid": "92130c1b-4fdb-4acc-86e0-1853d429c41a",
        "session_start_time": "2020-10-13T00:00:00",
        "session_uuid": "cf0460e2-8629-491e-8956-71a4537a1f9a",
        "session_number": 1,
        "session_end_time": null,
        "session_lab": "mrsicflogellab",
        "session_location": "serial2P_01",
        "task_protocol": "BALLL",
        "session_type": null,
        "session_narrative": null,
        "session_ts": "2021-04-17T19:25:48",
        "session_project": "ibl_neuropixel_brainwide_01",
        "nplot": 0,
        "nprobe": 0,
        "subject_nickname": "CSH_ZAD_029",
        "sex": "M",
        "subject_birth_date": "2020-03-31",
        "ear_mark": "RL",
        ...
        "subject_ts": "2020-09-24T00:07:37",
        "lab_name": "zadorlab",
        "subjectlab_ts": "2020-09-24T00:08:52",
        "responsible_user": "user011",
        "subjectuser_ts": "2020-09-24T00:08:50",
        "training_status": null,
        "good_enough_for_brainwide_map": null
    },
    {
        "subject_uuid": "70bf8cbd-d312-4654-a4ea-3a21ea2f541b",
        "session_start_time": "2020-09-29T00:00:00",
        "session_uuid": "d1ace80b-400e-4bf4-95bf-d2b3f838ca0f",
        "session_number": 1,
        "session_end_time": null,
        "session_lab": "mrsicflogellab",
        "session_location": "serial2P_01",
        "task_protocol": "LLLAAABBBB",
        "session_type": null,
        "session_narrative": null,
        "session_ts": "2021-04-17T19:25:50",
        "session_project": "ibl_neuropixel_brainwide_01",
        "nplot": 0,
        "nprobe": 0,
        "subject_nickname": "SWC_043",
        "sex": "M",
        "subject_birth_date": "2019-12-11",
        "ear_mark": "L",
        "subject_line": "C57BL/6J",
        "subject_strain": null,
        ...
        "protocol_number": 1,
        "subject_description": null,
        "subject_ts": "2020-09-24T00:07:36",
        "lab_name": "hoferlab",
        "subjectlab_ts": "2020-09-24T00:08:52",
        "responsible_user": "user058",
        "subjectuser_ts": "2020-09-24T00:08:50",
        "training_status": null,
        "good_enough_for_brainwide_map": null
    },
    {
        "subject_uuid": "70bf8cbd-d312-4654-a4ea-3a21ea2f541b",
        "session_start_time": "2020-09-23T14:46:29",
        "session_uuid": "7cdb71fb-928d-4eea-988f-0b655081f21c",
        "session_number": 1,
        "session_end_time": "2020-09-23T16:01:47",
        "session_lab": "mrsicflogellab",
        "session_location": "_iblrig_mrsicflogel_ephys_0",
        "task_protocol": "LAB",
        "session_type": "Experiment",
        "session_narrative": null,
        "session_ts": "2021-04-17T19:24:45",
        "session_project": "ibl_neuropixel_brainwide_01",
        "nplot": 1,
        "nprobe": 0,
        "subject_nickname": "SWC_043",
    ...
    // .set('limit', 2)
    // .set('page', 1)
    // .set('order', 'session_uuid DESC')

    // const limit = parseInt(size)

    // const skip = (page - 1) * size

    // console.log("HERE IS THE QUERY OBJECT: " + req.query)
    // console.log('posting to filter session page');
    // console.log('req.body: ', req.body)
    // console.log('type: ', typeof req.body)
    console.log("values-----" + req.query.page + "---" + req.query.limit)
